...
class Shot(db.Model):
    ...
    holeID = db.Column(db.Integer, db.ForeignKey('holes.holeID'), nullable=False)  # New column
    distance_before = db.Column(db.Float, nullable=False)
    lie_before = db.Column(db.String(50), nullable=False)
    distance_after = db.Column(db.Float, nullable=True)
    lie_after = db.Column(db.String(50), nullable=True)
    shot_type = db.Column(db.String(50), nullable=False)
    strokes_gained = db.Column(db.Float, nullable=True)
